...
% rephrase
Perennial biofuel crops such as Miscanthus (Miscanthus x giganteus) and switchgrass are promising on marginal lands because their perennial growth can support SOC recovery, reduce erosion, and lower fertilizer and water demand relative to annual biofuel crops \citep{Davis2009Placeholder,Zeri2013WUE,AndersonTeixeira2009SOC,Ferrarini2022Placeholder}. Their continuous below-ground biomass inputs can help slow soil carbon loss while preserving a bioenergy pathway for low-emission biomass production. In drylands, these traits make Miscanthus and switchgrass useful candidates for evaluating how land-use conversion affects soil carbon and related greenhouse gas outcomes.
...
The Permian Basin is a useful case study because aridity, wind exposure, and heterogeneous land cover make SOC accumulation difficult and magnify the effect of management choices. In this study, biogeochemical modeling and LCA were used to evaluate how land-use conversion and management affect SOC, yield, and net GHG balance at field and regional scales.
...
Results summary: SOC increased in all scenarios, making soil carbon the primary response across the modeled management options. Moisture availability was the main spatial control on the magnitude of those gains.
...
SOC increased in all scenarios (Fig. 4), consistent with \citep{Dohleman2009Miscanthus,Iqbal2015Placeholder,Jarecki2020Placeholder}, and indicating that all simulated management pathways supported net soil carbon gain.

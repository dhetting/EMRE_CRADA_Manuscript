...
% TODO [ONLINE-AGENT R2-07 — Fig 1 panel detail]: View figures/figure1.png and list each
% panel with the specific variable it shows (e.g., precipitation, Tmax, clay%, sand%, pH).
% Replace the generic caption below with a specific panel-by-panel description.
% Also note Choi's request to replace precipitation with aridity index (PET/P).
\manufig{figures/figure1.png}{Figure 1. Initial environmental conditions of the Permian Basin study area. Maps show spatial distributions of key climate and soil inputs derived from DAYMET (1980--2020 climatological means) and gSSURGO, including precipitation, temperature, and soil texture across the 182,575\,km$^2$ analysis domain at 1\,km resolution.}

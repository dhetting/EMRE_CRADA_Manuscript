...
\manufig{figures/figure3.png}{Figure 3. Change in soil organic carbon (integrated to 105\,cm depth) by management scenario and starting land cover. Box-and-whisker distributions of $\Delta$SOC at years 2030, 2050, and 2100; boxes show 25th/50th/75th percentiles, whiskers extend to 1.5$\times$IQR. \textit{Note: figure axis currently shows Mg\,CO$_2$e\,ha$^{-1}$; regenerate with Mg\,C\,ha$^{-1}$ before submission.}}

\manufig{figures/figure4.png}{Figure 4. Spatial pattern of $\Delta$SOC (integrated to 105\,cm depth) at year 2100, faceted by management scenario. Pixels are on the 1\,km grid covering the Permian Basin extent. \textit{Note: colour scale currently in Mg\,CO$_2$e\,ha$^{-1}$; regenerate in Mg\,C\,ha$^{-1}$ before submission.}}
...
\manufig{figures/figure5.png}{Figure 5. $\Delta$SOC (integrated to 105\,cm depth) trajectory by scenario and starting land cover across years 2030, 2050, and 2100. Lines show the mean across pixels; ribbons span the 25th--75th percentile. \textit{Note: y-axis currently in Mg\,CO$_2$e\,ha$^{-1}$; regenerate in Mg\,C\,ha$^{-1}$ before submission.}}
...
% TODO [ONLINE-AGENT FIG6-YIELD]: The biomass yield left panel in Figure 6 shows near-zero
% and negative values for all 16 scenarios. Harvested scenarios should show positive
% above-ground yield (expected: miscanthus 400-1500 g m⁻² yr⁻¹, switchgrass 200-800 g m⁻² yr⁻¹).
% This appears to be a figure generation bug (wrong column, wrong units, or unharvested
% scenarios included when only harvested scenarios are intended). Wang must investigate and
% regenerate Figure 6 before submission. Also confirm: caption says "8 of 16 scenarios"
% but figure appears to show all 16 scenarios.
\manufig{figures/figure6.png}{Figure 6. Supporting agronomic and soil-nitrogen outcomes at year 2100. Distributions of biomass yield (harvested scenarios only, 8 of 16 scenarios) and N$_2$O flux by management scenario, colored by starting land cover. \textit{Note: biomass yield panel appears to show near-zero values for all scenarios — likely a figure generation bug; see TODO comment above.}}

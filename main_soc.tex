...
Perennial biofuel crops can build SOC stocks on marginal land through deep root systems and extensive below-ground biomass \citep{Johnson2007BiomassCropping,Davis2012Agave}. Where harvested, the above-ground biomass supports bioenergy production; this study does not evaluate yield because biomass output data are not available in the canonical results dataset (see Results). Successful establishment depends on land suitability and water availability \citep{Field2017Placeholder,Kaye2018SoilCarbon}.
...
% scenario-specific depth fractions from 100-px AutoDAYCENT re-runs (job 14635917).

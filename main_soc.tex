...
Perennial biofuel crops can build SOC stocks and generate harvestable biomass simultaneously on marginal land. Shifting land use from degraded agriculture, sparse shrubland, or bare land to perennial crops like switchgrass or miscanthus engages deep root systems and extensive below-ground biomass that build long-term SOC \citep{Johnson2007BiomassCropping,Davis2012Agave}. The harvested biomass supports biofuel production, providing an economic incentive for land conversion \citep{VanDerWeijde2017Drought,Zalesny2020Placeholder}. Successful implementation depends on land suitability and water availability; economically feasible miscanthus and switchgrass cultivation hinges on local moisture conditions \citep{Field2017Placeholder,Kaye2018SoilCarbon}.
...
Under the selected crop parameterizations, modeled miscanthus scenarios produce higher SOC accumulation and greater CEC gains than modeled switchgrass scenarios across all scenario comparisons. Among the four management factors, irrigation produces the largest modeled SOC contrast: irrigated scenarios produce greater modeled SOC accumulation than rainfed counterparts across all three starting land covers. Irrigated scenarios throughout this paper are water-unconstrained model cases; they do not establish the feasibility of irrigation given water availability, infrastructure, or economic constraints in the Permian Basin. No-harvest scenarios retain all above-ground biomass as surface residue; they are included to isolate the effect of residue management on SOC dynamics and do not represent an operational bioenergy production strategy.
...
The DAYCENT simulations presented here consistently show that, under periodically repeated historical meteorology and specified crop parameterizations, perennial biofuel crop scenarios produce substantial modeled SOC accumulation relative to each land cover's own 2021 initial conditions across all 48 scenario--land-cover combinations. The scenario-mean $\Delta$SOC at 2100 ranges from 14 to 85\,Mg\,C\,ha$^{-1}$ (integrated to 105\,cm depth); this quantity cannot be directly compared to the gSSURGO 0--30\,cm baseline of 20.7\,Mg\,C\,ha$^{-1}$ because the depth intervals differ, and no business-as-usual continuation scenarios were run to isolate the land-use-change increment. Area-weighted over the study region (87\,\% shrubland), the scenario range narrows to 20--81\,Mg\,C\,ha$^{-1}$. The corresponding estimated CEC increases (1--5\,cmol$_\text{c}$\,kg$^{-1}$, conditional on a pH-dependent PTF) are agronomically significant relative to the baseline median.

Among the four management factors, irrigation is the dominant modeled driver of SOC accumulation in this factorial design. Irrigated scenarios produce greater SOC accumulation than rainfed counterparts in all land covers and across both crop parameterizations. Irrigated scenarios are water-unconstrained model cases; they do not establish the feasibility of irrigation in the Permian Basin. Residue retention (no-harvest management) amplifies SOC gains at the cost of moderately higher N$_2$O flux.
